//
//  PUsuarioTableViewController.swift
//  P5_QuizAppIOS2018
//
//  Created by Luis Martin de Vidales Palomero on 25/11/2018.
//  Copyright © 2018 UPM. All rights reserved.
//

import UIKit

class PUsuarioTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        cargaPreguntas(url: "https://quiz2019.herokuapp.com/api/users/" + self.i + "/quizzes?token=")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "Pregunta"{
            ...
            queue.async {
                ...
                print("https://quiz2019.herokuapp.com/api/quizzes/" + celula.id.text! + "?token=" + self.token)
